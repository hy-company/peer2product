...
class Transaction
{
    ...
    private function generateLoginToken()
    {
        ...
        // request time from pay.nl server
        $arrResult = $this->doRequest('Authentication/getTokenTime', array(), 5, 'v2');
        ...
        if(is_array($arrResult) && isset($arrResult['result']))
        {
           $iTimestamp = $arrResult['result'];
        }
      
        return sha1($this->getToken() . $iTimestamp);
    }
